...
if ($_SESSION['refroll_cv'] != 1) {
	...
	$resPedidos = $serviciosVentas->traerPedidosCerrados($idcliente);
} else {
	...
	<div class="todoMenu">
        ...
        <nav class="nav">
            <ul>
                ...
                <?php } else { ?>
                <li><div class="icoventas"></div><a href="index.php">Mis Compras</a></li>
...
<div id="ingoGral" style=" margin-left:60px; padding-top:20px;">
    ...
    <div class="boxInfo">
        <div id="headBoxInfo">
        	<p style="color: #fff; font-size:18px; height:16px;">Pedidos Finalizados</p>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li>
                                        <a href="javascript:void(0)" class="varmodificar" id="<?php echo $row['idpedido']; ?>">Modificar</a>
                                        </li>
