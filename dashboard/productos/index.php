...
<!--idproducto,nombre,precio_unit,precio_venta,stock,stock_min,reftipoproducto,refproveedor,codigo,codigobarra,caracteristicas -->
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="input-group col-md-12">
                        	<span class="input-group-addon">$</span>
                            <input type="text" class="form-control" id="precio_venta" name="precio_venta" required readonly>
                            <span class="input-group-addon">.00</span>
                        </div>
                    </div>
    ...
    <div class="boxInfoLargo">
        <div id="headBoxInfo">
        	<p style="color: #fff; font-size:18px; height:16px;">Todos Productos Cargados</p>
        </div>
    	<div class="cuerpoBox">
