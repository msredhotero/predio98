...
$refCliente = $serviciosUsuario->traerTodosUsuarios();
...
<div id="ingoGral" style=" margin-left:60px; padding-top:20px;">
    ...
    <div class="boxInfoLargo">
        <div id="headBoxInfo">
        	<p style="color: #fff; font-size:18px; height:16px;">Lista de Usuarios</p>
        </div>
    	<div class="cuerpoBox">
        <div class="row"> 
...
<!--idproducto,nombre,precio_unit,precio_venta,stock,stock_min,reftipoproducto,refproveedor,codigo,codigobarra,caracteristicas -->
                	<?php
						if (mysql_num_rows($refCliente)>0) {
							
							while ($row = mysql_fetch_array($refCliente)) {
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li>
                                        <a href="javascript:void(0)" class="btnDetalle" id="<?php echo $row['idusuario']; ?>">Ver</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
